...
echo "================LOADER=================="
mysql -u root --password=Fthyy*83 sim_data  < ./sql/Mortalidade_Geral_2012.sql
mysql -u root --password=Fthyy*83 sim_data  < ./sql/Mortalidade_Geral_2013.sql
mysql -u root --password=Fthyy*83 sim_data  < ./sql/Mortalidade_Geral_2014.sql
mysql -u root --password=Fthyy*83 sim_data  < ./sql/Mortalidade_Geral_2015.sql
mysql -u root --password=Fthyy*83 sim_data  < ./sql/Mortalidade_Geral_2016.sql
mysql -u root --password=Fthyy*83 sim_data  < ./sql/Mortalidade_Geral_2017.sql
mysql -u root --password=Fthyy*83 sim_data  < ./sql/Mortalidade_Geral_2018.sql
mysql -u root --password=Fthyy*83 sim_data  < ./sql/Mortalidade_Geral_2019.sql
mysql -u root --password=Fthyy*83 sim_data  < ./sql/Mortalidade_Geral_2020.sql
mysql -u root --password=Fthyy*83 sim_data  < ./sql/Mortalidade_Geral_2021.sql
mysql -u root --password=Fthyy*83 sim_data  < ./sql/Mortalidade_Geral_2022.sql
